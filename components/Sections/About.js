        ...
        <motion.section id="about" initial="hidden"
            ...
            <motion.div className="flex flex-col flex-nowrap w-full">
                ...
                >
                    ...
                    <motion.div className="col-span-1 row-span-2" variants={listItem}><img className="object-cover h-full rounded-2xl" src="../assets/images/about-me/1.jpg" /></motion.div>
                    <motion.div className="col-span-1 row-span-1" variants={listItem}><img className="object-cover h-full rounded-2xl" src="../assets/images/about-me/2.jpg" /></motion.div>
                    <motion.div className="col-span-1 row-span-1" variants={listItem}><img className="object-cover h-full rounded-2xl" src="../assets/images/about-me/4.jpg" /></motion.div>
                </motion.div>
            </motion.div>
